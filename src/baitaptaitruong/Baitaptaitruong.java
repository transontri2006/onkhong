 ...
 */
package baitaptaitruong;

import java.util.Random;
import java.util.Scanner;

public class Baitaptaitruong {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Random random = new Random();

        System.out.println("--- CHUONG TRINH TUY CHINH ---");

        // BT 1: So nguyen ngau nhien voi khoang tu nhap
        ...
        // BT 2: So thuc ngau nhien voi cong thuc yeu cau
        ...
        // BT 3: Lay so nguyen bat ky va kiem tra chan le
        ...
        // BT 4: So sanh so nhap vao voi so ngau nhien (dung cong thuc)
        ...
        // BT 5: Doan so den khi dung va dem so lan
        ...
        // BT 6: Tro choi doan so co goi y
